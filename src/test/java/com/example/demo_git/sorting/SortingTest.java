...
public class SortingTest {
 ...
 List<UserSortTest> getTestDealers() {
        ...
        user.products.add(new Price("Горох", BigDecimal.TEN, 100));
        ...
        UserSortTest user1 = new UserSortTest("Петр", "Петров", 101);
        ...
        UserSortTest user2 = new UserSortTest("Иван", "Петров", 106);
        ...
        UserSortTest user4 = new UserSortTest("Chuck", "Norris", 105);
        ...
        UserSortTest user5 = new UserSortTest("Иван", "Сидоров", 104);
...
public void testFilterName(){
    ...
    List<UserSortTest> sortedUserByName = dealers.stream().sorted(
            Comparator.comparing(UserSortTest::getUsername).thenComparing(UserSortTest::getUsername))
        .collect(
            Collectors.toList());
